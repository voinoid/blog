...
date: '2021-11-13'
tags: ['renewables', 'MV', 'distributed generation']
draft: false
...
Over the next few years most of the potential DG sites, with a strong connection to the grid, will have been used.
